...
const { getAllTask, createTask, updateTask, deleteTask, getTask, completeTask } = require('../controllers/taskController')
...
router.route('/complete/:taskID').patch(completeTask)
